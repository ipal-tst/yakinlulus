// src/app/(staff)/staff/schools/TargetSchoolTab.tsx
"use client";
...
export function TargetSchoolTab() {
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="text-lg font-semibold">Target Sekolah &amp; Kampus PTN</h3>
                    <p className="text-sm text-muted-foreground">
                        Kelola daftar target kampus, jurusan, dan standar passing grade ujian.
                    </p>
                </div>
