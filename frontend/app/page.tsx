...
import { Sun, Moon, RocketLaunch } from "@phosphor-icons/react";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground antialiased selection:bg-primary/20">
      ...
      <div className="bg-primary text-primary-foreground py-2 px-4 text-center text-xs font-medium flex items-center justify-center gap-2">
        <span>Promo Beta Testers: Gratis 6 Bulan Pertama untuk 500 Siswa Pendaftar Pertama!</span>
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/85 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-8">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-muted-foreground">
            ...
            <a href="#jenjang" className="hover:text-primary transition-colors">Jenjang</a>
